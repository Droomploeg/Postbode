...
namespace Droomploeg.Postbode.WebApp.Security;

[ExcludeFromCodeCoverage(Justification = "Route map builder extensions")]
internal static class RouteMapBuilderExtensions
{
