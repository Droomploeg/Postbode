...
public class PostbodeFixture
{
    ...
    public static async Task<PostbodeFixture> GetInstanceAsync()
    {
        ...
        try
        {
            ...
            var fixture = new PostbodeFixture();
    ...
    private async Task InitializeAsync()
    {
        var appHost = await DistributedApplicationTestingBuilder
            .CreateAsync<Projects.Droomploeg_Postbode_Aspire_Tests_AppHost>();
