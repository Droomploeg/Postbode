...
public interface IDeadLetterTopicRepository<TSendMessage, TReceiveMessage>
{
    /// <summary>
    ...
    Task<IEnumerable<TReceiveMessage>> PeekMessagesAsync(string topic, string subscription,
